...
import { userdata, useraddress, usersource, higher_education, education, ownerdata } from '../../Model/UserData';
...
export class UserHomeView extends Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="home">
                    <div className="homesearch" style={{width:'663px',float:'left'}}>
                        ...
                        <ul style={{height:'50px'}}>
                            <li style={{width:'80%'}}><input type="text" id="suggestion" onChange={() => hendelSuggestionlist.call(this)} placeholder="Skill,Company,Post,etc.." name="search" />
                                <div style={{top:'154px',width:'34.85%'}} className="suggestionhendel">
...
export default withRouter(connect(null, mapDispatchToProps)(UserHomeView));