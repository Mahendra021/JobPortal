...
import { userallData,userdata,useraddress,usersource,higher_education, FilterNameData } from '../../Model/UserData';
...
import { hendelSuggestionlistName,hendelSearchName,hendeluserexperience,hendelsalary } from './Filter';
import { CreateJsonSource2 } from '../../Controller/MapPage/CreateJsonSource';

mapboxgl.accessToken = 'pk.eyJ1IjoiZG1hbmNpbmkiLCJhIjoiY2loNzVmcHJqMGl4cnV1a2lvampzMWpoZSJ9.YXdMfQxLF_hS9Jrvu_9_Rw';
var globalThis = null
var history = createBrowserHistory();

export class MapJobseekerPageView extends Component {
    ...
    async componentDidMount() {
        ...
        var data = await userallData()
        if(href === '/jobseeker'){
            var data = await userallData()
        }
        else{
            var data = await FilterNameData('',params.search)
        }
        var features = CreateJsonSource2(data);
        ...
        map.on('load', function () {
            ...
            map.on('click', 'points', function (e) {
                ...
                if (features[0].properties.id !== undefined) {
                    history.push("/jobseekerdetail?id=" + features[0].properties.id)
            ...
            map.on('mouseenter', 'points', function (e) {
                ...
                popup = new mapboxgl.Popup({ offset: 25, closeButton: false })
                    ...
                    <img src="'+ features[0].properties.img + '" class="popupimg2"/>\
                    <div id="text-block">'+ features[0].properties.name + '\
                    <p class ="title">Course : '+ features[0].properties.title + '<br/></p>\
                    <p class ="title">Specialization : '+ features[0].properties.title + '<br/></p>\
    ...
    renderListings(feature) {
        ...
        if (feature.length) {
            ...
            feature.forEach(function (feature) {
                ...
                item.target = '_blank';
                item.onclick = () => {
                    history.push("/company/profile?id=" + feature.properties.id)
                    window.location.reload()
                }
                item.innerHTML = '<div class="mainHolder12" style="background-image: linear-gradient(to bottom, rgba(245, 246, 252, 0), rgba(0, 0, 0, 0.7)), url(' + "'" + feature.properties.img + "'" + ');">\
                <div id="list-block">'+ feature.properties.name + '\
                <p class ="title">Course : '+ feature.properties.title + '<br/></p>\
                <p class="title">Specialization : '+ feature.properties.title + '<br/></p>\
                ...
                item.addEventListener('mouseenter', function () {
                    ...
                    popup = new mapboxgl.Popup({ offset: 25, closeButton: false })
                        .setLngLat([longitude, latitude])
                        .setHTML('<div class="container">\
                        <img src="'+ feature.properties.img + '" class="popupimg2"/>\
        ...
        return (
            <div>
                <ul>
                    ...
                    <li className="fieldSearch"><input type="text" id="suggestion" onChange={() => hendelSuggestionlistName.call(this)} placeholder="Jobseeker,Skill,etc.." name="search" />
                        <div className="suggestionhendel">
                            <ul className="suggestionbox"></ul>
                        </div>
                    </li>
                    <li className="locationSearch">Location</li>
                    <li className="searchbotton" onClick={() => hendelSearchName.call(this,this.map)}>Search</li>
                </ul>
                    ...
                    <div>
                        ...
                        <div className="Filterdiv">
                            <div className="filterlist">Experience
                                <div className="experiencelist" style={{ marginTop: "4px", borderTop: " 1px solid black" }} onClick={() => hendeluserexperience.call(this, '1')}>1</div>
                                <div className="experiencelist" onClick={() => hendeluserexperience.call(this, '2')}>2</div>
                                <div className="experiencelist" onClick={() => hendeluserexperience.call(this, '3')}>3</div>
                                <div className="experiencelist" onClick={() => hendeluserexperience.call(this, '4')}>4</div>
                                <div className="experiencelist" style={{ borderBottom: 'none' }} onClick={() => hendeluserexperience.call(this, '5')}>5</div>
                            </div>
...
export default MapJobseekerPageView
